...
help:
	...
	@echo "  type-check     Run static type analysis using basedpyright"
...
type-check:
	uv run basedpyright $(TYPE_PATHS)
...
clean:
	rm -rf .mypy_cache/ .ruff_cache/ .pytest_cache/ .basedpyright_cache/ build/ dist/ *.egg-info
