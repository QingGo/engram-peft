...
class TestTokenizerCompressor(unittest.TestCase):
    ...
    def test_normalization(self):
        ...
        # Test space variants
        self.assertEqual(compressor._normalize_text("  \t\n  "), " ") # Merges to single space
        self.assertEqual(compressor._normalize_text("Hello  \t\n  World"), "hello world")
    ...
    def test_save_load(self):
        ...
        # Load it back
        loaded_compressor = TokenizerCompressor.from_pretrained(self.temp_dir, self.mock_tokenizer)
        
        self.assertEqual(compressor.compression_ratio, loaded_compressor.compression_ratio)
        self.assertEqual(compressor.vocab_size, loaded_compressor.vocab_size)
        self.assertEqual(compressor.compressed_vocab_size, loaded_compressor.compressed_vocab_size)
